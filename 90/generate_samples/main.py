...
parser.add_argument('--conv_layers', type = int, default = 100) # number of layers in the convnet - should be larger than the correlation length
...
parser.add_argument('--training_batch_size', type = int, default = 8) # maximum training batch size
...
parser.add_argument('--max_epochs', type = int, default =50) # number of epochs over which to train
parser.add_argument('--convergence_moving_average_window', type = int, default = 50) # BROKEN - moving average window used to compute convergence criteria
