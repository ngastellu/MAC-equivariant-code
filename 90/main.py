...
parser.add_argument('--max_epochs', type = int, default =1000) # number of epochs over which to train
parser.add_argument('--convergence_moving_average_window', type = int, default = 1550) # BROKEN - moving average window used to compute convergence criteria
